...
describeList = ['big nab','a qt','simp','hot','friendly','an irritating bitch','an ass','a dick','a hoe','dum','tiny','the best','the poggest','is sweet','is cute','<:bigbrain:838472543705759824>','teeny brain','an alien','a waifu','a dumbass']
...
async def say(context,whatToSay):
    await context.message.channel.send(whatToSay)
