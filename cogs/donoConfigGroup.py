...
class donoConfigGroup(commands.Cog):
    ...
    @commands.group(name='set',invoke_without_commands=True)
    async def set(self,ctx):
        setEmbed = discord.Embed(title='inkBot guild specific configs')
    
    @set.command(name='giveawayManagerRole', aliases=['gmanrole', 'gr'])
    ...
    @set.command(name='eventManagerRole', aliases=['emanrole', 'er'])
    @commands.check_any(commands.is_owner(), commands.has_guild_permissions(administrator=True))
    ...
    @set.command(name='modRole', aliases=['mrole', 'mr'])
    @commands.check_any(commands.is_owner(), commands.has_guild_permissions(administrator=True))
    ...
    @set.command(name='adminRole', aliases=['arole', 'ar'])
    @commands.check_any(commands.is_owner(), commands.has_guild_permissions(administrator=True))
